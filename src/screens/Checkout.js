...
const Checkout = ({ route }) => {
    ...
    const [useAlphaSizes, setUseAlphaSizes] = useState(false);
    ...
    const toggleAlphaSizes = () => {
        setUseAlphaSizes(!useAlphaSizes);
        setSelectedSize('');
    };

    const sizes = useAlphaSizes ? ['S', 'M', 'L', 'XL', 'XXL'] : [38, 40, 42, 44, 46];
            ...
            <ScrollView>
                <View style={style.container}>
                    <View style={style.header}>
                        ...
                        <Text style={style.headerText}>{selectedItem.title}</Text>
                    ...
                    <View style={style.detailsContainer}>
                        <View style={style.detail}>
                            <Text style={style.title}>{selectedItem?.title} <Text style={style.track}>{selectedItem?.track}</Text></Text>
                        ...
                        <View style={style.deliveryContainer}>
                            ...
                            <Text>Seller : <Text style={[style.priceValue, { color: 'red' }]}>Vishal Mega Mart</Text></Text>
                        </View>
