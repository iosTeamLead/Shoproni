...
const Data = [
  {
    id: 1,
    image: require('../../assets/Shirts/shirt1.jpeg'),
    title: 'Roadster',
    track: 'Men Pure Cotton Casual Shirt',
    Price: '₹ 740',
  ...
  {
    id: 2,
    image: require('../../assets/Shirts/shirt2.jpeg'),
    title: 'Mast&Harbour',
    track: 'Men Slim Fit Sustainable shirt',
    Price: '₹ 640',
  ...
  {
    id: 3,
    image: require('../../assets/Shirts/shirt3.jpeg'),
    title: 'Snitch',
    track: 'Embellished PArty Shirt',
    Price: '₹ 1,315',
  ...
  {
    id: 4,
    image: require('../../assets/Shirts/shirt4.jpeg'),
    title: 'The Indian ',
    track: 'Men Slim Fit Casual Shirt',
    Price: '₹ 650',
    Best_Price: 'Best Price ₹423 ',
    qty:0
  },
  {
    id: 5,
    image: require('../../assets/Shirts/shirt5.jpeg'),
    title: 'Roadster',
    track: 'Men  Casual Shirt',
    Price: '₹ 645',
  ...
  {
    id: 6,
    image: require('../../assets/Shirts/shirt6.jpeg'),
    title: 'RARE RABBIT',
    track: 'Slim Fit  Cotton Casual Shirt',
    Price: '₹ 1,924',
  ...
  {
    id: 7,
    image: require('../../assets/Shirts/shirt7.jpeg'),
    title: 'Mast & Harrbour',
    track: 'Checked Regular Casual Shirt',
    Price: '₹ 790',
  ...
  {
    id: 8,
    image: require('../../assets/Shirts/shirt8.jpeg'),
    title: 'Powerlook',
    track: 'Oversized Casual Shirt',
    Price: '₹ 1299',
  ...
  {
    id: 9,
    image: require('../../assets/Shirts/shirt9.jpeg'),
    title: 'HERE & NOW',
    track: 'Men Regular Fit Shirt',
    Price: '₹ 940',
  ...
  {
    id: 10,
    image: require('../../assets/Shirts/shirt10.jpeg'),
    title: 'UNRL',
    track: 'Pure Cotton Casual Shirt',
    Price: '₹ 1740',
  ...
  {
    id: 11,
    image: require('../../assets/Shirts/shirt11.jpeg'),
    title: 'LOCOMOTIVE',
    track: 'Men Slim Fit Casual Shirt',
    Price: '₹ 540',
  ...
  {
    id: 12,
    image: require('../../assets/Shirts/shirt12.jpeg'),
    title: 'WRONG',
    track: 'Cotton Casual Shirt',
    Price: '₹ 1,385',
    Best_Price: 'Best Price ₹899 ',
    qty:0
  },
  {
    id: 13,
    image: require('../../assets/Shirts/shirt13.jpeg'),
    title: 'Bergamo',
    track: 'Slim Fit Knitted Shirt',
    Price: '₹ 1,299',
  ...
  {
    id: 14,
    image: require('../../assets/Shirts/shirt14.jpeg'),
    title: 'HIGHLANDER',
    track: 'Printed Slim Fit Cotton  Shirt',
    Price: '₹ 549',
  ...
  {
    id: 15,
    image: require('../../assets/Shirts/shirt15.jpeg'),
    title: 'Nautica',
    track: 'Men Pure Cotton Casual Shirt',
    Price: '₹ 1,240',
  ...
  {
    id: 16,
    image: require('../../assets/Shirts/shirt16.jpeg'),
    title: 'INVICTUS',
    track: 'Easy Care Men Casual Shirt',
    Price: '₹ 999',
    Best_Price: 'Best Price ₹599 ',
    qty:0
  },
  ...
  return (
    <SafeAreaView>
      <View style={style.view}>
        ...
        <Text style={{ color: 'gray,', fontSize: 20, fontWeight: '500' }}>{t('common.shirts')} </Text>
